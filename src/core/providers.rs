...
use crate::core::provider::{classify_provider, AppKind, Provider, ProviderType};
...
impl ProviderStore {
    ...
    pub fn save(&self, config_dir: &Path) -> anyhow::Result<()> {
        ...
        let providers_path = providers_path(config_dir);
        crate::core::storage::write_json_pretty(&providers_path, self)
    ...
    pub fn remove_universal_derivative(&mut self, universal_id: &str, app: AppKind) -> bool {
        let provider_id =
            crate::core::universal_providers::universal_provider_id(universal_id, app);
