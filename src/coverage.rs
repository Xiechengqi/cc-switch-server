...
use crate::core::provider::{AppKind, Provider, ProviderType};
...
impl ProviderCoverage {
    pub fn load_embedded() -> anyhow::Result<Self> {
        let raw = include_str!("../docs/provider-coverage.json");
...
mod tests {
    use super::*;
    use crate::core::provider::classify_provider;
    ...
    fn exported_provider_structures_cover_required_fields() {
        let raw = include_str!("../docs/provider-fixtures/structures.json");
