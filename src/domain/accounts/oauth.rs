...
pub fn oauth_provider_spec(provider_type: ProviderType) -> Option<OAuthProviderSpec> {
    match provider_type {
        ...
        ProviderType::AmazonQOAuth => Some(OAuthProviderSpec {
            provider_type,
            stage: OAuthSupportStage::NativeRefreshProfile,
            authorize_url: None,
            authorize_flow: OAuthAuthorizeFlow::Unsupported,
            ...
            client_secret_env: None,
            refresh_scope: None,
            user_agent: Some("AmazonQ-For-CLI"),
            profile_url: None,
            profile_strategy: OAuthProfileStrategy::ProviderSpecific,
            quota_strategy: OAuthQuotaStrategy::ProviderSpecific,
            refresh_capability: OAuthRefreshCapability::ProviderDynamic,
        ...
        ProviderType::CodeBuddyOAuth => Some(OAuthProviderSpec {
            provider_type,
            stage: OAuthSupportStage::NativeRefreshProfile,
            authorize_url: None,
            authorize_flow: OAuthAuthorizeFlow::Unsupported,
            ...
            client_secret_env: None,
            refresh_scope: None,
            user_agent: Some("cc-switch-server-codebuddy"),
            profile_url: None,
            profile_strategy: OAuthProfileStrategy::ProviderSpecific,
            quota_strategy: OAuthQuotaStrategy::ProviderSpecific,
            refresh_capability: OAuthRefreshCapability::ProviderDynamic,
        ...
        ProviderType::TraeSolo => Some(OAuthProviderSpec {
            provider_type,
            stage: OAuthSupportStage::NativeRefreshProfile,
            authorize_url: None,
            authorize_flow: OAuthAuthorizeFlow::Unsupported,
            ...
            client_secret_env: None,
            refresh_scope: None,
            user_agent: Some("cc-switch-server-trae-solo"),
            profile_url: None,
            profile_strategy: OAuthProfileStrategy::ProviderSpecific,
            quota_strategy: OAuthQuotaStrategy::ProviderSpecific,
            refresh_capability: OAuthRefreshCapability::ProviderDynamic,
