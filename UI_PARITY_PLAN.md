...
- `ProviderStatsTable` 与 `ModelStatsTable` 退役 table 渲染，改为 usage ranking card grid；每张卡展示 provider/model 图标、rank、token share meter、requests/success/cost/latency/last request 等摘要。
