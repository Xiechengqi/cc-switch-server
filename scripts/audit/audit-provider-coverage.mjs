...
function serverEvidenceNotes() {
  return [
    ...
    "- The fixed-origin client issues the two official requests concurrently with a sensitive Bearer header, exact methods and paths, a 15-second timeout, a 512 KiB response limit, and redirects disabled. It validates bounded typed fields, preserves `0%`, rejects invalid ratios and unsafe values, distinguishes authentication/rate-limit/transient/invalid-response failures, and never returns upstream response bodies or the API key in public errors.",
