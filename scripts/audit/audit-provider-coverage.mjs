...
function serverEvidenceNotes(qoderVerification) {
  return [
    ...
    "",
    "Server-native Kiro protocol implementation reviewed through 2026-09-11 against OmniRoute `918fba5e392ce8b137976349f035597196edc440`, 9router `15223724c3e1ad898e84ef6e0cc1686cbafc8290`, and the committed prompt-cache deltas in `kiro.rs@22d2c2d0695ba350890072c19990f54782827ae5`. Local fixture verification does not imply live-account acceptance:",
    "",
    ...
    "- Evidence: `assets/contract/kiro-wire-protocol.json` and `assets/contract/kiro-reference-delta.json` are consumed directly by Rust and static audits for endpoint, image, decoder, runtime-model, three-surface bridge, prompt-cache semantics, usage conservation, and SQLite recovery. KI-01 through KI-03 are `fixture_verified`. KI-04 remains `live_pending` until Builder ID/IdC/Social/API Key are each tested in `us-east-1` and `eu-central-1` for Claude/Codex non-stream/stream, cache modes/TTLs/bounds, upstream usage, refresh, throttling, and stable errors. KI-05 shared cache remains runtime-disabled pending explicit multi-replica need and evidence. Amazon Q has its own fixture and live gate below.",
    "",
