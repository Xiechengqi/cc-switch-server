...
function serverEvidenceNotes() {
  return [
    ...
    "- Wire profile and discovery: `assets/contract/claude-oauth-wire-profile.json` records a sanitized static audit of the official npm stable Claude Code `2.1.236` native binary, Stainless `0.112.1`, Node `v26.3.0`, and Axios `1.15.2`; its static protocol tokens have no material delta from 2.1.234. It excludes credentials, identifiers, raw bodies and private build metadata. It versions endpoint identities, CCH/beta rules and the Fable 5, Opus 5, Opus 4.8, Sonnet 5, Opus/Sonnet 4.6 and Haiku 4.5 catalog. Discovery performs zero OAuth/upstream requests and remains fixture-verified; real subscription-account verification is pending.",
