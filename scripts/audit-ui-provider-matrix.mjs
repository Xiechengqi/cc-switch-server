...
const files = {
  ...
  providerMatrix: path.join(repoRoot, "src/core/provider_matrix.rs"),
  provider: path.join(repoRoot, "src/core/provider.rs"),
  accountManagers: path.join(repoRoot, "src/core/account_managers.rs"),
  accountRefresh: path.join(repoRoot, "src/core/account_refresh.rs"),
  oauthClients: path.join(repoRoot, "src/core/oauth_clients.rs"),
};
