...
const evidence = {
  ...
  longTailInputsPresent: {
    ...
    qoderGlobalOauthShareId: Boolean(env("CC_SWITCH_QODER_GLOBAL_OAUTH_SHARE_ID")),
    ...
    qoderGlobalPatShareId: Boolean(env("CC_SWITCH_QODER_GLOBAL_PAT_SHARE_ID")),
    ...
    qoderCnOauthShareId: Boolean(env("CC_SWITCH_QODER_CN_OAUTH_SHARE_ID")),
    codebuddyIntlAccount: Boolean(env("CODEBUDDY_INTL_TEST_ACCOUNT")),
    codebuddyIntlClaudeProviderId: Boolean(env("CC_SWITCH_CODEBUDDY_INTL_CLAUDE_PROVIDER_ID")),
    codebuddyIntlCodexProviderId: Boolean(env("CC_SWITCH_CODEBUDDY_INTL_CODEX_PROVIDER_ID")),
    codebuddyIntlGeminiProviderId: Boolean(env("CC_SWITCH_CODEBUDDY_INTL_GEMINI_PROVIDER_ID")),
    codebuddyIntlShareId: Boolean(env("CC_SWITCH_CODEBUDDY_INTL_SHARE_ID")),
    codebuddyIntlModel: env("CC_SWITCH_CODEBUDDY_INTL_MODEL"),
    codebuddyIntlReceiptFile: Boolean(env("CODEBUDDY_INTL_REAL_RECEIPT_FILE")),
    codebuddyCnAccount: Boolean(env("CODEBUDDY_CN_TEST_ACCOUNT")),
    codebuddyCnClaudeProviderId: Boolean(env("CC_SWITCH_CODEBUDDY_CN_CLAUDE_PROVIDER_ID")),
    codebuddyCnCodexProviderId: Boolean(env("CC_SWITCH_CODEBUDDY_CN_CODEX_PROVIDER_ID")),
    codebuddyCnGeminiProviderId: Boolean(env("CC_SWITCH_CODEBUDDY_CN_GEMINI_PROVIDER_ID")),
    codebuddyCnShareId: Boolean(env("CC_SWITCH_CODEBUDDY_CN_SHARE_ID")),
    codebuddyCnModel: env("CC_SWITCH_CODEBUDDY_CN_MODEL"),
    codebuddyCnReceiptFile: Boolean(env("CODEBUDDY_CN_REAL_RECEIPT_FILE")),
    ...
    kiroSignedUser: Boolean(env("CC_SWITCH_KIRO_SIGNED_USER")),
    kiroSessionId: Boolean(env("CC_SWITCH_KIRO_SESSION_ID")),
    kiroBuilderIdUsEast1ReceiptFile: Boolean(env("KIRO_BUILDER_ID_US_EAST_1_REAL_RECEIPT_FILE")),
    kiroBuilderIdEuCentral1ReceiptFile: Boolean(env("KIRO_BUILDER_ID_EU_CENTRAL_1_REAL_RECEIPT_FILE")),
    kiroIdcUsEast1ReceiptFile: Boolean(env("KIRO_IDC_US_EAST_1_REAL_RECEIPT_FILE")),
    kiroIdcEuCentral1ReceiptFile: Boolean(env("KIRO_IDC_EU_CENTRAL_1_REAL_RECEIPT_FILE")),
    kiroSocialUsEast1ReceiptFile: Boolean(env("KIRO_SOCIAL_US_EAST_1_REAL_RECEIPT_FILE")),
    kiroSocialEuCentral1ReceiptFile: Boolean(env("KIRO_SOCIAL_EU_CENTRAL_1_REAL_RECEIPT_FILE")),
    kiroApiKeyUsEast1ReceiptFile: Boolean(env("KIRO_API_KEY_US_EAST_1_REAL_RECEIPT_FILE")),
    kiroApiKeyEuCentral1ReceiptFile: Boolean(env("KIRO_API_KEY_EU_CENTRAL_1_REAL_RECEIPT_FILE")),
  ...
  checks: nonEmptyObject({
    ...
    kiroBuilderIdUsEast1GateStatus: env("KIRO_BUILDER_ID_US_EAST_1_GATE_STATUS"),
    kiroBuilderIdEuCentral1GateStatus: env("KIRO_BUILDER_ID_EU_CENTRAL_1_GATE_STATUS"),
    kiroIdcUsEast1GateStatus: env("KIRO_IDC_US_EAST_1_GATE_STATUS"),
    kiroIdcEuCentral1GateStatus: env("KIRO_IDC_EU_CENTRAL_1_GATE_STATUS"),
    kiroSocialUsEast1GateStatus: env("KIRO_SOCIAL_US_EAST_1_GATE_STATUS"),
    kiroSocialEuCentral1GateStatus: env("KIRO_SOCIAL_EU_CENTRAL_1_GATE_STATUS"),
    kiroApiKeyUsEast1GateStatus: env("KIRO_API_KEY_US_EAST_1_GATE_STATUS"),
    kiroApiKeyEuCentral1GateStatus: env("KIRO_API_KEY_EU_CENTRAL_1_GATE_STATUS"),
    ...
    codebuddyIntlGateStatus: env("CODEBUDDY_INTL_GATE_STATUS"),
    codebuddyCnGateStatus: env("CODEBUDDY_CN_GATE_STATUS"),
