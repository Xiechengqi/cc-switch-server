...
Claude OAuth protocol evidence review from `/data/projects/proxy/Claude/Claude.md` through 2026-07-24, implemented independently in Server:
...
Codex/OpenAI OAuth protocol evidence review from `/data/projects/proxy/pi`, `/data/projects/proxy/Codex/codex2api`, `/data/projects/proxy/Codex/Codex.md` v2 P0-P2, and TokenRouter account-candidate filtering through 2026-07-24, implemented independently in Server. `pi` is used as the official OAuth/client-behavior reference, not as the multi-account server architecture template:
