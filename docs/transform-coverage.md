...
| SSE frame boundary slicing (half frame, multi-frame, CRLF) | Partial | CRLF and multi-frame chunks covered; half-frame buffering remains a forwarder/adapter state design task. |
