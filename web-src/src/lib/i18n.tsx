  ...
  zh: {
    ...
    server: {
      ...
      auth: {
        ...
        setupSubtitle: "设置 Owner 邮箱、Router、管理员密码，并完成邮箱验证码绑定。",
        setupEmailHint: "Router 会向 Owner 邮箱发送验证码，用于绑定 Client Tunnel 所有权。",
        setupVerificationRequired: "请先获取并填写 Owner 邮箱验证码。",
        methodPassword: "密码",
        methodEmail: "邮箱验证码",
  ...
  en: {
    ...
    server: {
      ...
      auth: {
        ...
        setupSubtitle: "Configure owner email, router, admin password, and verify the owner email code.",
        setupEmailHint: "Router sends a verification code to bind Client Tunnel ownership.",
        setupVerificationRequired: "Request and enter the owner email verification code first.",
