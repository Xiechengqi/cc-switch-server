  ...
  zh: {
    ...
    server: {
      ...
      auth: {
        ...
        clientSubdomainAuto: "留空将自动生成随机单词子域名",
  ...
  "zh-TW": {
    ...
    server: {
      ...
      auth: {
        ...
        clientSubdomainAuto: "留空將自動生成隨機單詞子網域",
  ...
  en: {
    ...
    server: {
      ...
      auth: {
        ...
        clientSubdomainAuto: "Leave blank to auto-generate a memorable subdomain",
  ...
  ja: {
    ...
    server: {
      ...
      auth: {
        ...
        clientSubdomainAuto: "空欄のままにすると読みやすいサブドメインを自動生成します",
